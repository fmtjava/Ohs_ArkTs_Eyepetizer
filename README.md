...
一款基于 ArkTS + 鸿蒙 6.0 + AI + NDK 实现的精美仿开眼视频 App(提供Kotlin、Flutter、React Native、SwitfUI、小程序版本 😁 <br /><br />
...
# 前言
最近充电了 ArkTs + 鸿蒙应用开发相关的技能，通过这个项目把学到的相关技能记录下来，因为目前还在持续学习鸿蒙应用开发相关技能，希望 Github 的小伙伴多多 Issues，留下你们的宝贵意见。当前如果觉得项目能够帮助到你们，也希望给一个 `Star` 或 `Fork` ^_^ ，谢谢**
...
# Thanks
  ...
  - [harmony-utils](https://gitee.com/tongyuyan/harmony-utils)
